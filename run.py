...
for seed in seeds:
    ...
    if model_name=='LTFGW_GCN':
        ...
        model=LTFGW_MLP(n_nodes=n_nodes,n_classes=n_classes,n_features=n_features, n_templates=n_templates,n_templates_nodes=n_templates_nodes,hidden_layer=hidden_layer,k=k,dropout=dropout,alpha0=alpha0,local_alpha=local_alpha,shortest_path=shortest_path)
    ...
    filename_save_test=os.path.join( 'new_results',method,"test_{}_seed{}_lr{}_n_temp{}_n_nodes{}_alpha0{}_k{}_local_alpha{}_dropout{}_shortest_path{}.csv".format(dataset_name,first_seed,lr,n_templates,n_templates_nodes,alpha0,k,local_alpha,dropout,shortest_path))
