...
class LTFGW_MLP_dropout(nn.Module):
    def __init__(self,n_nodes,n_classes=2,n_features=10, n_templates=10,n_templates_nodes=10,hidden_layer=10,k=1,alpha0=None,train_node_weights=True, skip_connection=True,local_alpha=True,shortest_path=False):
        """
        n_classes: number of classes for node classification
        n_features: number of features for each node
        n_templates: number of templates to use for LTFGW
