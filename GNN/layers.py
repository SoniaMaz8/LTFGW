...
class LTFGW_log(nn.Module):
    ...
    def __init__(self,n_nodes, n_templates=10,n_templates_nodes=10,n_features=10,k=1,alpha0=None,mean_init=0,std_init=0.001,train_node_weights=True,local_alpha=True,shortest_path=False):
        ...
        templates,templates_features=template_initialisation(self.n_templates_nodes,self.n_templates,self.n_features, mean_init, std_init)
    ...
    def forward(self, x, edge_index):
        ...
        x=torch.log(distance_to_template(x,edge_index,self.templates_features,self.templates,alpha,q,self.k,self.local_alpha,self.shortest_path))
        return x
